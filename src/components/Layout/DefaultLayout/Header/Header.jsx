...
const MENU_ITEMS = [
  {
    icon: <i className="icon fa-solid fa-language"></i>,
    title: "English",
    children: {
      title: "Language",
      data: [
        { type: "language", code: "en", title: "English" },
        { type: "language", code: "vi", title: "VietNam" },
      ],
    },
  },
  {
    icon: <i className="icon fa-solid fa-circle-question"></i>,
    title: "Feedback and help",
    to: "/feedback",
  },
  {
    icon: <i className="icon fa-solid fa-keyboard"></i>,
...
export default function Header() {
  ...
  const userMenu = [
    ...
    {
      icon: <i className="icon fa-solid fa-coins"></i>,
      title: "Get coin",
      to: "/coin",
    },
    {
    ...
    ...MENU_ITEMS,
    {
      icon: <i className="icon fa-solid fa-right-from-bracket"></i>,
      title: "Log out",
      to: "/logout",
      separate: true,
    },
